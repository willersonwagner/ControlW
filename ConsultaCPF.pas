...
var
  ConsultaCPF1: TConsultaCPF1;

implementation

{$R *.dfm}

procedure TConsultaCPF1.btnConsultarClick(Sender: TObject);
begin
...
procedure TConsultaCPF1.FormShow(Sender: TObject);
begin
  Timer1.Enabled := True;
  EditCaptcha.SetFocus;
end;

procedure TConsultaCPF1.LabAtualizarCaptchaClick(Sender: TObject);
var
...
procedure TConsultaCPF1.Timer1Timer(Sender: TObject);
begin
