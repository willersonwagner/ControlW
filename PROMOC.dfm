object promocao: Tpromocao
  Left = 192
  Top = 124
  Caption = 'Formul'#225'rio de Promo'#231#245'es'
  ClientHeight = 316
  ClientWidth = 503
  Color = clBtnFace
  ...
  object ckproduto: TRadioButton
    ...
    TabOrder = 8
    TabStop = True
    OnClick = ckprodutoClick
  end
  object ckgrupo: TRadioButton
    Left = 88
    Top = 8
    Width = 65
    Height = 17
