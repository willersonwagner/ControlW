  ...
  object PageControl3: TPageControl
    ...
    object TabSheet2: TTabSheet
      ...
      object Label9: TLabel
        ...
        Width = 147
        Height = 13
        Caption = 'Qual o Modelo da Impressora ?'
      end
      ...
      object Label21: TLabel
        ...
        Height = 39
        Caption = 
          'Essa Configura'#231#227'o s'#243' deve ser Habilitada'#13#10'caso use driver de com' +
          'unica'#231#227'o virtual e se '#13#10'estiver dando problemas'
        Color = clBtnFace
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clRed
        Font.Height = -11
      ...
      object Imprimir_Desconto: TCheckBox
        Left = 32
        Top = 232
        Width = 137
        Height = 17
        Caption = 'Imprimir Desc. Produto'
        TabOrder = 6
      end
      object controledeporta: TCheckBox
        Left = 32
        Top = 256
        Width = 105
        Height = 17
    ...
    object TabSheet6: TTabSheet
      ...
      object Label22: TLabel
        ...
        Height = 64
        Caption = 
          'Essa Configura'#231#227'o s'#243' deve ser Habilitada'#13#10'caso use o sistema use' +
          ' bd independente de'#13#10'Servidor, esse terminal tem um banco de dad' +
          'os'#13#10'que ser'#225' sincronizado com o bd do servidor.'
        Color = clBtnFace
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clRed
        Font.Height = -13
